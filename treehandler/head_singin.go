...
const (
	databaseURL = "https://login-credentials-b0464-default-rtdb.firebaseio.com"
)
...
func LoginHandlervalidator(w http.ResponseWriter, r *http.Request) {
	if r.Method == http.MethodGet {
		http.ServeFile(w, r, filepath.Join("static", "head_signin.html"))
		return
	}
